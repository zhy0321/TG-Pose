...
#                           iou_3d_thresholds=[0.1], iou_pose_thres=0.1, use_matches_for_pose=False, eval_recon=False,
#                           plot_figure=True):
...
#         ax_iou.plot(100 * np.array(iou_thres_list), 100 * np.array(iou_3d_aps[cls_id, :]), color=colors[cls_id - 1],
#                     linestyle=styles[cls_id - 1],
#                     label=class_name)
#
#     iou_3d_aps[-1, :] = np.mean(iou_3d_aps[1:-1, :], axis=0)
#     ax_iou.plot(100 * np.array(iou_thres_list), 100 * np.array(iou_3d_aps[-1, :]), color=colors[6], linestyle=styles[6],
#                 label='mean')
...
#     ax_trans.set_title('Rotation', fontsize=10)
#     ax_trans.set_ylim(0, 100)
#     ax_trans.yaxis.set_ticklabels([])
#     ax_trans.set_xlabel('Degree')
#     ax_trans.set_xlim(0, 6)
#     ax_trans.xaxis.set_ticks([0, 2, 4, 6])
#     ax_trans.grid()
#
...
#         # print(class_name)
#         ax_trans.plot(
#             degree_thres_list[:-1], 100 * pose_aps[cls_id, :-1, -1], color=colors[cls_id - 1],
#             linestyle=styles[cls_id - 1], label=class_name)
#
#     ax_trans.plot(degree_thres_list[:-1], 100 * pose_aps[-1, :-1, -1], color=colors[6],
#                   linestyle=styles[6], label='mean')
#     pose_dict['aps'] = pose_aps
#
#     ax_rot = plt.subplot(133)
#     # plt.ylim((0, 1))
#     # plt.xlabel('translation/cm')
#     ax_rot.set_title('Translation', fontsize=10)
#     ax_rot.set_ylim(0, 100)
#     ax_rot.yaxis.set_ticklabels([])
#     ax_rot.set_xlabel('Centimeter')
#     ax_rot.set_xlim(0, 10)
#     ax_rot.xaxis.set_ticks([0, 5, 10])
#     # ax_rot.grid()
#     for cls_id in range(1, num_classes):
#         class_name = synset_names[cls_id]
#         # print(class_name)
#         ax_rot.plot(shift_thres_list[:-1],
#                     100 * pose_aps[cls_id, -1, :-1], color=colors[cls_id - 1],
#                     linestyle=styles[cls_id - 1], label=class_name)
#
#     ax_rot.plot(shift_thres_list[:-1], 100 * pose_aps[-1, -1, :-1], color=colors[6],
#                 linestyle=styles[6], label='mean')
